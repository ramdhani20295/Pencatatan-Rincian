...
<head>
	...
	include 'config.php';
	?>
	<title>AJB BUMIPUTERA USER</title>
...
<body>
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="http://www.malasngoding.com" class="navbar-brand">AJB BUMIPUTERA USER</a>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="lapor.php"><span class="glyphicon glyphicon-briefcase"></span>  Laporan</a></li>
